...
`开启 ELITE_BUILD_EXAMPLES 后，会自动编译 examples 目录下所有 .c 示例程序。默认输出到 build/examples/ 或 build\examples\Release\。当前 examples 已兼容 Linux 和 Windows 编译。`
...
编译完成后会生成共享库 `elite_cs_series_sdk_c`。
